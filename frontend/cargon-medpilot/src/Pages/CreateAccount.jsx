...
import { AdminIDContext, AdminIDUpdateContext, DistributorIDUpdateContext, FactoryIDContext, FactoryIDUpdateContext } from "../Context/IDContextProvider";
...
export default function CreateAccount() {
  ...
  const [image,setImage]=useState("https://i.postimg.cc/6QfBGRgv/20721056-46.jpg")
  ...
  const addDistributor=async ()=>{
    ...
    try {
      ...
      .then((res)=>{
        ...
        //alert("Admin Created")
        updateDistributorID(res.data.adminstrator_id)
