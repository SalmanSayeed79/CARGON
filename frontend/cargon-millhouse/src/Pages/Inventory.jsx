...
export default function Inventory() {
  ...
  const inventoryURL=`${baseURL}/inventories/factory/${factoryIDSaved}`
        ...
        <Grid item xs={10} md={7}>
          <Box>
            ...
            <Box sx={{ marginTop: "2vh", width: { xs: "90%", md: "82%" } }}>
              ...
              {inventoryData.length==0 && <Paper elevation={4} sx={{width:"100%",minHeight:"10vh",display:"flex",alignItems:"center",justifyContent:"center"}}>
