        ...
        <Grid container> 
          ...
          <Box>
            ...
            <Paper elevation={5} sx={{display:"flex",flexDirection:"column",width:{xs:"90%",md:"25%"},minHeight:"15vh",marginTop:"2vh",marginRight:"2vw",alignItems:"flex-start",justifyContent:"center",backgroundColor:"success.light"}}>
              ...
              {!loading && <Typography variant="h2" ><CountUp start={0} duration={1} end={distData.length} ></CountUp></Typography>}
              </Box>
            </Paper>
            
           
            </Box>
              {!loading && <Box sx={{marginTop:"2vh",width:{xs:"90%",md:"82%"}}}>
                {distData.map(a=><DistributorCard data={a}/>)}
              </Box>}
