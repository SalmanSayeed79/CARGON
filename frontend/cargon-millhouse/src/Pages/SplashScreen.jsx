  ...
  return (
    <Paper  >
        {screen==0 && <Box sx={{minHeight: "100vh", width: "100vw",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center" }}>
            <Box component="img" src="https://i.postimg.cc/4xxPtTJc/millhouse.png" sx={{width:"200px"}} className="grow"/>
          <Typography variant="h6" sx={{marginTop:"1vh"}} color="primary.main">Welcome to MillHouse</Typography>
        </Box>}
